...
title DYD - Instalador y Servidor
...
if errorlevel 1 (
    ...
    echo.
    echo Vas a necesitar Node.js para jugar.
    echo.
    choice /C SN /N /M "Presiona S para descargar Node.js ahora, N para salir: "
...
echo Descargalo, instalalo y luego volve a ejecutar este archivo.
echo.
timeout /t 3 >nul
